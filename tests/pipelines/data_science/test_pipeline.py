...
from bank_transaction_user_segmentation.pipelines.data_science import create_pipeline as create_ds_pipeline
from bank_transaction_user_segmentation.pipelines.data_science.nodes import split_data
